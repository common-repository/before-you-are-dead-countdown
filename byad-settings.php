    ...
    public function admin_init() {
      ...
      add_settings_field(
        ...
        array(
          ...
          'description' => __("Optionally you can specify at what time (HH:MM) you'll die on your Final date (leave empty to die at midnight at the end of the day)", 'byad-countdown'),
